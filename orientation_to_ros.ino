...
ros::NodeHandle nh;
// Make a ros publisher for orientation
std_msgs::String str_msg;
ros::Publisher orientation_pub("arduino/orientation", &str_msg);
...
void loop(void)
{
  ...
  String roll = String(filter.getRoll());
  String pitch = String(filter.getPitch());
  String heading = String(filter.getYaw());
  Serial.print(millis());
  ...
  str_msg.data = String("y:" + heading + " " + "p:" + pitch + " " + "r:" + roll).c_str();
  orientation_pub.publish(&str_msg);
  nh.spinOnce();
